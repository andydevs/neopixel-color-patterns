...
Adafruit_ColorRGB COLORS[NUM_COLORS] = {
  Adafruit_ColorRGB(1.00, 0.00, 0.00),
  Adafruit_ColorRGB(1.00, 0.25, 0.00),
  Adafruit_ColorRGB(1.00, 0.50, 0.00),
  Adafruit_ColorRGB(0.00, 1.00, 0.00),
  Adafruit_ColorRGB(0.00, 0.00, 1.00),
  Adafruit_ColorRGB(1.00, 0.00, 1.00),
};
